...
<div id="adminMainContent">
	...
	<h2>Edit Event</h2>
		...
		<form method="post" action="/admin/events.php?a=edit">
			<span class="label">Event ID:</span>{$event_id}<br/>
			<span class="label">University:</span>{$school}<br/>
			...
			<span class="label">About the Event:</span><textarea name="description" class="textbox">{$description}</textarea><br/>
